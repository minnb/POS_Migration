...
| Tạo stored procedure mới cho `RPOSMasterData` / `RPOSCentralSales` / `RPOSLoyalty` | **`.claude/skills/database/SKILLS.md`** (quy tắc đặt tên `usp_{Domain}_{Action}`, TVP, template SP) |
