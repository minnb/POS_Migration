# /add-dto — Thêm DTO mới vào src/POS.Common/
...
```
/add-dto POS.Backend/API_Common/Dtos/NewDomain/NewDto.cs
```

**Cách 2 — Cung cấp tên class:**
```
/add-dto class NewOrderDto, domain Orders, thuộc API_Common
```

**Cách 3 — Nhiều DTO cùng lúc (từ commit hoặc ngày):**
```
/add-dto từ commit abc1234
/add-dto từ ngày 2026-06-01
```
