...
(function ($) {
    ...
    $.fn.fSelect = function (options) {        
        ...
        fSelect.prototype = {            
            ...
            buildOptions: function ($element) {
                ...
                //debugger
                var choices = '';
                if (this.settings.isSelectAll) {
                    choices += '<div class="fs-option" data-value="-" data-index="-1"><span class="fs-checkbox"><i></i></span><div class="fs-option-label111">Tất cả</div></div>';
                }
            ...
            reloadDropdownLabel: function () {
                ...
                this.$wrap.find('.fs-option.selected').each(function (i, el) {                    
                    var indexOption = el.dataset.index;
                    if (indexOption >= 0)
    ...
    $(document).on('click', '.fs-option:not(.hidden, .disabled)', function (e) {
        ...
        var do_close = false;
        var selectAll = parseInt($(this).attr('data-index'));//-1
        ...
        if ($wrap.hasClass('multiple')) {
            ...
            if (selectAll == -1) {
                ...
                if (addOrRemove) {
                    ...
                    $('.fs-label-wrap').attr('data-selectall', 1);
                    $wrap.find('.fs-option').toggleClass('selected');
                    do_close = true;
                }
                else {
                    $wrap.find('.fs-option').removeClass('selected');
                    $('.fs-label-wrap').attr('data-selectall', 0);
                }
            }
            else {
                // shift + click support
                if (e.shiftKey && null != window.fSelect.last_choice) {
                    ...
                    $wrap.find('.fs-option[data-index=-1]').removeClass('selected');
                    $('.fs-label-wrap').attr('data-selectall', 0);
                }
            }
            $wrap.find('.fs-option.selected').each(function (i, el) {
