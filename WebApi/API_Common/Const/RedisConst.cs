...
{ 
    public static class RedisConst
    {
        ...
        {
            return RedisKeyConst.GetShardKeyPrefix(RedisConst.Redis_Key_Loyalty_BalancePoints, hashField, 3);
        }
        public static string GetRedisKeyLoyaltyMemberPoints(string hashField)
        {
            return RedisKeyConst.GetShardKeyPrefix(RedisConst.Redis_Key_Loyalty_MemberPoints, hashField);
        }
    }
}
